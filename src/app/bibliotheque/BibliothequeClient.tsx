...
export default function BibliothequeClient({ videos }: { videos: SanityVideo[] }) {
            ...
            {filtered.map((video) => (
              ...
              >
                ...
                <div
                  style={{
                    ...
                    background: video.thumbnail
                      ? `url(${urlFor(video.thumbnail).width(600).url()}) center/cover`
                      : categoryColors[video.category] ?? 'var(--blush)',
                    position: 'relative',
                    display: 'flex',
                    alignItems: 'center',
                ...
                >
                  ...
                  {/* Favori */}
                  <button
                    onClick={(e) => { e.stopPropagation(); toggleFav(video._id); }}
                    style={{
                      position: 'absolute',
                      top: '0.75rem',
                      right: '0.75rem',
